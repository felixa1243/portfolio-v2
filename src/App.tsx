...
import {Card, Navbar, Reveal, TypeWriter} from "./components";
...
function App() {
    ...
    return (
        <div className="h-screen scroll-smooth max-w-screen">
            <Navbar/>
            <div
                className="w-full h-fit flex items-center gap-5 px-5 xs:px-3 py-5 xs:pt-[85px] xs:pb-5 bg-neutral-900 text-white xs:flex-col relative xs:items-start"
                id={"home"}>
                <div className="w-1/2 xs:w-full xs:h-fit h-full flex flex-col justify-between relative">
                    <Reveal className="w-fit py-3 overflow-hidden">
                        <h2 className="text-6xl xs:text-3xl font-bold">Hello, <br/> I'm Rajiph <br/> iqbal ghandi</h2>
                    </Reveal>
                    <TypeWriter
                    ...
                    <Reveal className="w-fit">
                        <div className="flex gap-3 mt-5">
                            <a href="mailto:felixarajiph@gmail.com"
                               className="w-fit h-fit border border-2 px-5 py-3 xs:text-[12px] xs:py-3 xs:px-3 gap-3 font-bold font-poppins flex items-center justify-center rounded-xl hover:shadow hover:shadow-white">CONTACT
                                ME <BsFillPersonFill/></a>
                            <a href="cv-rajiph-iqbal.pdf"
                               className="w-fit h-fit border border-2 px-5 py-3 xs:text-[12px] xs:py-3 xs:px-3 gap-3 font-bold font-poppins flex items-center justify-center rounded-xl hover:shadow hover:shadow-white">DOWNLOAD
                                CV <BsFillArrowDownCircleFill/></a>
                        </div>
                    </Reveal>
                    <Reveal>
                ...
                <div
                    className="w-1/2 xs:w-full xs:h-fit h-full flex flex-col justify-center xs:bg-gray-300 xs:hover:bg-gray-100 xs:mt-5">
                    <img src={profile} className="grayscale hover:grayscale-0 object-cover object-center w-full h-fit"
                         alt="hero"/>
                </div>
                <div className={"flex items-center gap-3 absolute bottom-3 xs:bottom-0 left-3 xs:hidden"}>
                    ...
                    <div
                        ...
                        <Reveal>
                            <p className={"text-justify"}>
                                I am a fullstack developer who work with java spring boot and react with a passion for
                                solving problems and building scalable and efficient systems. I am a quick learner and
                                enjoy learning new technologies and frameworks. I am excited to continue building my
                                skills and gain experience in the field of backend development. In my free time, I enjoy
            ...
            <div className="w-full h-fit xs:h-fit py-5 flex flex-col gap-5 justify-center items-center bg-black"
                 id={"projects"}>
                <Reveal>
                    <h2 className="text-2xl justify-self-start text-amber-500">Projects</h2>
                </Reveal>
                <div className="grid xs:grid-cols-1 grid-cols-2 gap-5 xs:justify-center xs:items-center p-5">
                    {
                        projects.map(item => {
                            return (
                                                  ...
                                                  <div className={"w-full flex gap-3 mt-3"}>
                                                      {
                                                          item.iconList.map(ic => {
                                                              return (
                                                                  <ic.icon key={ic.name} className={"text-2xl"}/>
                                                              )
                                                          })
                                                      }
                                                  </div>
            ...
            <div className="w-full h-fit xs:h-fit py-5 flex flex-col gap-5 justify-center items-center bg-neutral-900"
                 id={"certificates"}>
                <Reveal>
            ...
            <div className={"w-full h-fit xs:h-fit py-5 flex flex-col gap-5 justify-center items-center bg-black"} id={"contact"}>
                <Reveal>
                ...
                <form
                    ...
                    placeholder={"enter your message here!"}
                        className={"h-[150px] rounded-lg focus:outline-none px-3 py-2"} id={"message"}></textarea>
                    <button
